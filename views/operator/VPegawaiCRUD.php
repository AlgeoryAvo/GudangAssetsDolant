<div class="main-content">
    <section class="section">
        ...
        <buttton class="btn btn-primary mb-3" data-toggle="modal" data-target="#TambahPegawai"><i class="fas fa-user-plus fa-sm"></i> Tambah Pegawai</buttton>
        ...
        <table class="table table-hover table-striped table-bordered">
            ...
            ?>
                <tbody>
                    ...
                    <td>
                        <?php echo anchor(
                            'operator/CPegawaiCRUD/halamanUpdate/' . $pgna->id_pengguna,
                    ...
                    <td>
                        <!-- <a class="btn btn-danger btn-sm" 
                            ...
                            href="<?php echo base_url('operator/CPegawaiCRUD/fungsiDelete/') . $pgna->id_pengguna ?>">
                            <i class="fa fa-trash"></i>
                        </a> -->

                        <a onclick="deleteConfirm('<?php echo site_url('operator/CPegawaiCRUD/fungsiDelete/' . $pgna->id_pengguna) ?>')" href="#!" class="btn btn-sm btn-danger "><i class="fa fa-trash"></i></a>
                    </td>
                </tbody>
            <?php endforeach; ?>
        </table>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url('operator/CPegawaiCRUD/fungsiTambah') ?>" method="post" enctype="multipart/form-data">
